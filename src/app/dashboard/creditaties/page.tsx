...
function Creditaties(): JSX.Element {
  const data = {
    data: [],
    meta: {
      current_page: 1,
  ...
  return <TableBasic headers={headers} data={data} title="Credit Overview" />;
}

export default Creditaties;
Creditaties.Layout = "Dashboard";
