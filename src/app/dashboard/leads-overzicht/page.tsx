...
function MyLeads(): JSX.Element {
    ...
    data: [
      {
        ...
        job_type: "Gratis Dakinspectie Aanvragen",
  ...
  return <TableBasic headers={headers} data={data} title="My Leads Overview" />;
}

export default MyLeads;
MyLeads.Layout = "Dashboard";
